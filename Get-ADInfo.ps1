...
Ce script PowerShell collecte des informations clés sur un environnement Active Directory, utiles notamment pour :

Vérifier les prérequis avant le déploiement ou la mise à niveau d’un serveur Exchange.

Générer un rapport HTML synthétique sur la forêt et les domaines AD.
...
.EXAMPLE
.\Get-ADInfo.ps1
Runs the script and generates the output in the same Directory.
